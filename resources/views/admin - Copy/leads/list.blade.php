					...
					<div class="page-header">
						<div class="row">
                            ...
                            <div class="float-right col-auto ml-auto">
                                <a href="javascript::void()" class="btn add-btn" data-toggle="modal" data-target="#add_lead"><i class="fa fa-plus"></i> Add Lead</a>
                            </div>
						</div>
					</div>
					<!-- /Page Header -->
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table mb-0 table-striped table-nowrap custom-table datatable">
									<thead>
										<tr>
											<th>#</th>
											<th>Lead Name</th>
