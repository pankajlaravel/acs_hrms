...
<div class="content">
                ...
                <div class="col-md-12"> 
                    <div class="main-container-unique">
                        <div class="main-header-unique">
                            ...
                            <button data-bs-toggle="modal" data-bs-target="#add_subCategory">Add</button>
                        </div>
    ...
    <!-- Add Holiday Modal -->
    @include('admin.subCategory.add_popup')
    <!-- /Add Holiday Modal -->
    
    <!-- Edit Holiday Modal -->
    @include('admin.subCategory.edit_popup')
...
<script>
    ...
    $(document).on('click', '.editCategory', function() {
        ...
        $.get('/admin/sub-category-list/edit/' + cat_id, function (data) {
    ...
    $.ajax({
    url: '/admin/sub-category-list/${userId}/update', // Adjust the URL as needed
    type: 'POST',
    contentType: false,
    processData: false,
    ...
    success: function(response) {
        ...
        setTimeout(function() {
            window.location.href = '/admin/sub-category-list'; // Redirect to home page
        }, 3000);
...
<script>
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '/admin/sub-category-list/delete/' + category_id,
                method: 'DELETE',
                success: function(response) {
                    Swal.fire(
                        'Deleted!',
