    ...
    <form id="editEmploymentForm" class="employee-details" method="PUT" style="display:none;">
        <h3>Edit Previous Employment Details</h3>
        @csrf
        <input type="hidden" id="id" name="id">
        <div class="mb-3">
            <label for="employee_id" class="form-label">Employee ID</label>
            <input type="text" class="form-control employee_id" id="" name="employee_id" placeholder="Enter company name" readonly >
        </div>
