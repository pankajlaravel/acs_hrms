<div class="header">
   ...
   <ul class="nav user-menu">
      ...
      <li class="nav-item dropdown">
         <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown2">
                  ...
                  <li class="notification-message">
                     <a href="chat.php">
                        <div class="list-item">
                           <div class="list-left">
                              <span class="avatar">
                              <img alt="" src="admin/assets/img/profiles/avatar-09.jpg">
                              </span>
                           </div>
                           <div class="list-body">
                  ...
                  <li class="notification-message">
                     <a href="chat.php">
                        <div class="list-item">
                           <div class="list-left">
                              <span class="avatar">
                              <img alt="" src="admin/assets/img/profiles/avatar-05.jpg">
                              </span>
                           </div>
                           <div class="list-body">
                  ...
                  <li class="notification-message">
                     <a href="chat.php">
                        <div class="list-item">
                           <div class="list-left">
                              <span class="avatar">
                              <img alt="" src="admin/assets/img/profiles/avatar-08.jpg">
                              </span>
                           </div>
                           <div class="list-body">
      ...
      <li class="nav-item dropdown has-arrow main-drop">
         ...
         <span class="user-img"><img src="{{asset('employee/img/'.auth()->user()->picture)}}" alt="User Picture" height="20px" width="30px">
