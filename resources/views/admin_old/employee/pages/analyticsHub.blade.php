                    ...
                    <div class="card">
                      <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs">
                          <li class="nav-item">
                            <a href="#tabs-home-1" class="nav-link active" data-bs-toggle="tab">All</a>
                          </li>
                          <li class="nav-item">
                            <a href="#tabs-profile-1" class="nav-link" data-bs-toggle="tab">Personal Information (PII Data)</a>
                          </li>
                          <li class="nav-item">
                            <a href="#tabs-basic-1" class="nav-link" data-bs-toggle="tab">Basic Information</a>
                          </li>
                          <li class="nav-item">
                            <a href="#tabs-joining-1" class="nav-link" data-bs-toggle="tab">Joining Information</a>
                          </li>
                          <li class="nav-item">
                            <a href="#tabs-position-1" class="nav-link" data-bs-toggle="tab">Position Information</a>
                          </li>
                          <li class="nav-item">
                            <a href="#tabs-address-1" class="nav-link" data-bs-toggle="tab">Address Information</a>
                          </li>
